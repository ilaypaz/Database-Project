...
<body>
    ...
    try {
    $sql = "SELECT SSN, Name, Start_Registration_Date, Date_of_Birth, Major, Minor, Message_Content, Advisor_EID FROM Student WHERE Major = :major";

    $stmnt = $conn->prepare($sql);

    $stmnt->bindParam(':major', $_POST['dept']);
